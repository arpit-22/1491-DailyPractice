...
const Try = () => {
  ...
  <table className="w-full text-base text-left text-white dark:text-gray-400">
        <thead className="text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 hover:bg-gray-500 hover:text-white">
            <tr>
        ...
        <>
          ...
          <div className="mb-6">
            <input
              ...
              onChange={(e)=> setUpdateData({...updateData,plan:e.target.value})}
            />
          </div>
          </form>
                  </div>
